    ...
    <div>
        ...
        <div className='flex flex-col justify-center my-10 md:flex-row gap-10 mb-28 text-sm'> 
          ...
          <div className='flex flex-col justify-center gap-6 items-start'>
            ...
            <p className='text-gray-500'>Tel: +91 8969-XXX-XXX <br />
            Email: dhiraj8969@gamil.com</p>
            <p className='font-semibold text-lg text-gray-600'>CAREERS AT PRESCRIPTO</p>
            <p className='text-gray-500'>Learn more about our teams and job openings.</p>
            <button className='border border-black px-8 py-4
            text-sm hover:bg-black hover:text-white transition-all duration-500 cursor-pointer'>Explore Jobs</button>
          </div>
        </div>
